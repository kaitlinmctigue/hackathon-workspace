        ...
        return (
            <div>
                ...
                <div onClick={this.toggleModal}
                     className={"card-patient " + ((this.props.patient.sex.toString() == 'Male') ? 'card_left-border--male' : 'card_left-border--female')}>
                    ...
                    <div
                        className="card_name">{this.props.patient.name.fname}, {this.props.patient.name.lname}</div>
